...
// 	protoc        v3.15.8
// source: gubernator/gubernator.proto
...
func (Algorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_gubernator_gubernator_proto_enumTypes[0].Descriptor()
}

func (Algorithm) Type() protoreflect.EnumType {
	return &file_gubernator_gubernator_proto_enumTypes[0]
}
...
func (Algorithm) EnumDescriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{0}
}
...
func (Behavior) Descriptor() protoreflect.EnumDescriptor {
	return file_gubernator_gubernator_proto_enumTypes[1].Descriptor()
}

func (Behavior) Type() protoreflect.EnumType {
	return &file_gubernator_gubernator_proto_enumTypes[1]
}
...
func (Behavior) EnumDescriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{1}
}
...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_gubernator_gubernator_proto_enumTypes[2].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_gubernator_gubernator_proto_enumTypes[2]
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetRateLimitsReq) Reset() {
	*x = GetRateLimitsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[0]
...
func (x *GetRateLimitsResp) Reset() {
	*x = GetRateLimitsResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *RateLimitReq) Reset() {
	*x = RateLimitReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *RateLimitResp) Reset() {
	*x = RateLimitResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimitResp) Descriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{3}
}
...
func (x *HealthCheckReq) Reset() {
	*x = HealthCheckReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckReq) Descriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{4}
}
...
func (x *HealthCheckResp) Reset() {
	*x = HealthCheckResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gubernator_gubernator_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckResp) Descriptor() ([]byte, []int) {
	return file_gubernator_gubernator_proto_rawDescGZIP(), []int{5}
}
...
var File_gubernator_gubernator_proto protoreflect.FileDescriptor

var file_gubernator_gubernator_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x67, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x67, 0x75, 0x62,
	0x65, 0x72, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x70,
	0x62, 0x2e, 0x67, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x4b, 0x0a, 0x10,
	...
	0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x70, 0x62, 0x2e, 0x67, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x61, 0x74,
	0x6f, 0x72, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x52,
	0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x4f, 0x0a, 0x11, 0x47, 0x65, 0x74,
	0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x3a,
	...
	0x09, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x22, 0x8a, 0x02, 0x0a, 0x0c, 0x52,
	0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	,
	...
	0x47, 0x49, 0x4f, 0x4e, 0x10, 0x10, 0x2a, 0x29, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x01, 0x32, 0xaa, 0x01, 0x0a, 0x02, 0x56, 0x31, 0x12, 0x54, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x52,
	...
	0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x4e,
	...
	0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x1a, 0x1e, 0x2e, 0x70,
	0x62, 0x2e, 0x67, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x22,
...
var (
	file_gubernator_gubernator_proto_rawDescOnce sync.Once
	file_gubernator_gubernator_proto_rawDescData = file_gubernator_gubernator_proto_rawDesc
)

func file_gubernator_gubernator_proto_rawDescGZIP() []byte {
	file_gubernator_gubernator_proto_rawDescOnce.Do(func() {
		file_gubernator_gubernator_proto_rawDescData = protoimpl.X.CompressGZIP(file_gubernator_gubernator_proto_rawDescData)
	})
	return file_gubernator_gubernator_proto_rawDescData
}

var file_gubernator_gubernator_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_gubernator_gubernator_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_gubernator_gubernator_proto_goTypes = []interface{}{
...
var file_gubernator_gubernator_proto_depIdxs = []int32{
...
func init() { file_gubernator_gubernator_proto_init() }
func file_gubernator_gubernator_proto_init() {
	if File_gubernator_gubernator_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gubernator_gubernator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gubernator_gubernator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gubernator_gubernator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gubernator_gubernator_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gubernator_gubernator_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gubernator_gubernator_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gubernator_gubernator_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_gubernator_gubernator_proto_goTypes,
		DependencyIndexes: file_gubernator_gubernator_proto_depIdxs,
		EnumInfos:         file_gubernator_gubernator_proto_enumTypes,
		MessageInfos:      file_gubernator_gubernator_proto_msgTypes,
	}.Build()
	File_gubernator_gubernator_proto = out.File
	file_gubernator_gubernator_proto_rawDesc = nil
	file_gubernator_gubernator_proto_goTypes = nil
	file_gubernator_gubernator_proto_depIdxs = nil
}
